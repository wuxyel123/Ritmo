            ...
            ScrollView {
                VStack(spacing: RitmoTheme.gap) {
                    ...
                    if !vm.history.isEmpty {
                        ...
                        macroChart("Calorie",   \.calories,         goals.dailyCalories,    "kcal", RitmoTheme.calories, .bar)
                        macroChart("Proteine",  \.protein,          goals.dailyProteinG,    "g",    RitmoTheme.protein,  .line)
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                if expanded {
                    VStack(alignment: .leading, spacing: 8) {
                        Text("Ritmo legge i dati nutrizionali direttamente da Apple Salute. Per far apparire i tuoi pasti qui, connetti la tua app di tracciamento alimentare ad Apple Salute:")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                        ...
                        VStack(alignment: .leading, spacing: 6) {
                            ...
                            infoStep("4", "I dati appariranno automaticamente in Ritmo")
                        }
