...
struct DayScoreDetailSheet: View {
                    ...
                    FitCard {
                        VStack(alignment: .leading, spacing: 14) {
                            ...
                            ScoreComponentRow(
                                ...
                                score: snapshot.recoveryScore, maxScore: 30, color: RitmoTheme.sleep
                            )
                            Divider()
                            ScoreComponentRow(
                                ...
                                score: snapshot.nutritionScore, maxScore: 20, color: RitmoTheme.calories
                            )
                            Divider()
                            ScoreComponentRow(
                                ...
                                score: snapshot.workoutBonus, maxScore: 10, color: RitmoTheme.workout
                            )
                        }
                    }
    ...
    private func explanationRow(_ title: LocalizedStringKey, _ body: LocalizedStringKey) -> some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            Text(body).font(.caption).foregroundStyle(RitmoTheme.textSecondary)
        }
    }
}
