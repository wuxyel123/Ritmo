                ...
                LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible()),
                    ...
                    ForEach(presets, id: \.0) { label, ml in
                        Button {
                            ...
                            .padding(.vertical, 14)
                            .background(FitSyncTheme.water.opacity(0.12),
                                        in: RoundedRectangle(cornerRadius: 12))
                            .overlay(RoundedRectangle(cornerRadius: 12)
                                .strokeBorder(FitSyncTheme.water.opacity(0.3), lineWidth: 1))
                            .foregroundStyle(FitSyncTheme.water)
                        }
                        .buttonStyle(.plain)
                    }
                    ...
                    HStack {
                        ...
                        Button {
                            ...
                            Text("Aggiungi")
                                ...
                                .padding()
                                .background(FitSyncTheme.water, in: RoundedRectangle(cornerRadius: 12))
                        }
